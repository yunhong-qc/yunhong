...
//    			<div  style="width:100%;height:100%;opacity: 0.3;text-align:center;top:0px;left:0px;background-color:black;position:fixed;">
    			var _html='<div style="width:100px;height:30px;color:white;margin-left:auto; margin-right:auto;margin-top:'+top+'px;"><img onclick="_loading.hide();" src="'+host+'" style="display: inline-block;vertical-align: middle;" /><label style="font-size:14px;">&nbsp;&nbsp;加载中...</label><div>';
